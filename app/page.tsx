  ...
  try {
        ...
        <main className="flex-1 container py-8 px-4 mx-auto max-w-5xl">
          ...
          {courses.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm">Clique em "Atualizar Cursos" para buscar cursos do Google Drive.</p>
            </div>
          ) : (
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <p className="text-muted-foreground mb-6">Ocorreu um erro ao carregar a lista de cursos.</p>
        <UpdateCoursesButton />
      </div>
    )
  }
